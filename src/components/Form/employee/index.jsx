...
export const EmployeeForm = () => {
    const { AddEmployee, EmployeeData } = React.useContext(EmployeeContext);
    ...
    const handleSubmit = async (event) => {
      ...
      const sucess = await AddEmployee(nif, name, finalEmail, nivel_acesso);
        ...
        if(sucess) {
          ...
          Notification("sucess", "Funcionário não foi criado")
        }
  ...
  return (
    <>
        ...
        <form className='flex flex-col gap-4 mt-4' onSubmit={handleSubmit}> 
            <InputText disabled={finishForm} value={name} onChange={handleNameChange} name="Nome completo:" id="nome" text="nome" />
            ...
            <div className='relative'>
              ...
              <InputText disabled={finishForm} value={email} errorValidacao={email.error} onChange={handleEmailChange}  name="Email:" id="email" text="email" placeholder="ex:marlene" />
            </div>
            
            <InputText disabled={finishForm} value={nif} onChange={handleNifChange} name="NIF:" id="nif" text="nif" placeholder=" NN.NNN.NNN/NNNN-NN" />
            ...
            <div className='flex gap-2'>
              <InputRadioInformation
                      ...
                      description="✔ Adicionar usuários, ✔ Remover usuários, ✔ Adicionar alunos ✔ Editar alunos "
                      disabled={finishForm}
              />
